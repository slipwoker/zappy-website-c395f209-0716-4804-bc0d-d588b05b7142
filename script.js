  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      contactForm.dispatchEvent(
        new CustomEvent('formValidated', { bubbles: true, detail: { form: contactForm } })
      );
    });
  }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c395f209-0716-4804-bc0d-d588b05b7142',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c395f209-0716-4804-bc0d-d588b05b7142';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c395f209-0716-4804-bc0d-d588b05b7142';
